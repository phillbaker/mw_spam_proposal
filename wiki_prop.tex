...
In addition, [8] argues that, in the end, only humans will be able to identify spam, since any purely statistical method is doomed to fail in the face of spammers’ reverse engineering efforts. While perhaps true on distributed blog sites where single spam comments may not receive many views, this likely not true in a centralized, high traffic collaborative site like Wikipedia.
